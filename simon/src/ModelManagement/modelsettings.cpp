...
ModelSettings::ModelSettings(QWidget* parent): QWidget(parent) // SystemWidget(i18n("Modelleinstellungen"), KIcon("applications-education-language"), i18n("Hier können Sie Einstellungen rund um das Sprachmodell einstellen"), parent)
{
	ui.setupUi(this);

	ui.kcfg_ModelTrainingsDataPath->setMode(KFile::Directory | KFile::ExistingOnly | KFile::LocalOnly );
