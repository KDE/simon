 ...
 */
ExternalProgramManager::ExternalProgramManager(QWidget* parent):QWidget(parent)// SystemWidget(i18n("Externe Programme"), KIcon("applications-other"), i18n("Externe Programme verwalten"), parent)
{
	ui.setupUi(this);
