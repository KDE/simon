...
バージョン 4.1.4 はバグ修正のリリースです．Microsoft Visual C++ 2008 
における Julius ラッパークラスの改善，Windows におけるオーディオ入力
の改善と録音デバイス選択機能の追加，Mac OS X 10.6 SDK への対応が行わ
れました．変更点の詳細な一覧は Release-ja.txt をご覧ください．
