...
macro(export_component component)
    ...
    IF(${QT_MOBILITY_VERSION} VERSION_EQUAL 1.0.0)
        SET(QT_MOBILITY_${_COMPONENT}_INCLUDE_DIR ${QT_MOBILITY_INCLUDE_DIR})
    ELSE()
        SET(QT_MOBILITY_${_COMPONENT}_INCLUDE_DIR ${QT_MOBILITY_INCLUDE_DIR}/Qt${component})
    ENDIF()
	if(WIN32)
		FIND_LIBRARY(QT_MOBILITY_${_COMPONENT}_LIBRARY NAMES Qt${component} Qt${component}1 PATH /usr/lib /usr/local/lib F:/kde/qt-mobility-opensource-src-1.1.0/lib C:/QtMobility/lib) 
	ELSE(WIN32)
