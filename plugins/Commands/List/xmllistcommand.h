...
#ifndef SIMON_XMLLISTCOMMAND_H_AEA964D4D1DF43D183F9AA64AB7D17DF
#define SIMON_XMLLISTCOMMAND_H_AEA964D4D1DF43D183F9AA64AB7D17DF
...
class XMLListCommand : public XMLDomReader {
	
public:
	XMLListCommand(const QString& path="");
