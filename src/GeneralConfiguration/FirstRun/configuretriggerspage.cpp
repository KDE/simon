 ...
 : QWizardPage(parent)
{
	...
	connect(ui.leMainTrigger, SIGNAL(textChanged(QString)), this, SIGNAL(completeChanged()));
	connect(ui.leDesktopgridTrigger, SIGNAL(textChanged(QString)), this, SIGNAL(completeChanged()));
}
