...
namespace Simond
{
	enum Request {
		...
		ModelCompilationWordUndefined=3004,
		ModelCompilationPhonemeUndefined=3005,
		ModelCompilationClassUndefined=3006,
		GetModelCompilationProtocol=3007,
		ErrorRetrievingModelCompilationProtocol=3008,
		ModelCompilationProtocol=3009,
		ModelCompilationCompleted=3010,
