...
unsigned int CoreEvents::generalizeKey(unsigned int key /*unicode representation*/)
{
	//substitute non-standard keys in different keyboard layouts
	//with their general equivalent
	//small greek letters
	switch (key)
	{
		case 945:
