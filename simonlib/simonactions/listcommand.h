...
protected:
	...
	/**
	 * \brief Constructor
	 * \param parentManager The parent command manager. This can be NULL if the list is not in any scenario.
	 */
...
public:
	...
	*/
	 ...
	 * \param manager The parent command manager (can be NULL if outside a manager)
	 * \param element The XML element to deserialize from
	 * \return The created ListCommand or NULL if creation failed
	 */
