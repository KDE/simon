...
protected:
	 ...
	 *
	 * \warning This doesn't always need to be != NULL. In fact, checking if this is NULL is a good 
	 ...
	 * but can of course handle a NULL value. If you, however, use a command configuration 
